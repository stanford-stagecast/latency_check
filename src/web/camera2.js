...
function sourceOpenVideo(e) {
    ...
    var videobump = function() {
	    ...
	    if ( videoSourceBuffer.buffered.length > 0 ) {
		var buffer_duration = (videoSourceBuffer.buffered.end(0) - video.currentTime);
		document.getElementById('videobuffer').innerHTML = "buffer: " + (1000*buffer_duration).toFixed(0) + " ms";
    ...
    document.getElementById('zooms').innerHTML = 'Camera control for: <b><span id="text:live"></span></b><br><button onclick="reset_controls();" type="button">Reset controls</button><br><span style="float: left; width: 200px;" id="text:zoom:x">x</span><input type="range" min="0" max="1280" step="1" id="zoom:x" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:zoom:y">y</span><input type="range" min="0" max="1280" step="1" id="zoom:y" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:zoom:zoom">zoom</span><input type="range" min="1" max="3" step="0.001" id="zoom:zoom" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:left">crop</span><input type="range" min="0" max="1280" step="1" id="crop:left" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:right">crop</span><input type="range" min="0" max="1280" step="1" style="transform: rotate(180deg); width: 1280px;" id="crop:right" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:top">crop</span><input type="range" min="0" max="720" step="1" id="crop:top" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:bottom">crop</span><input type="range" min="0" max="720" step="1" id="crop:bottom" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br>';
    
    ws = new WebSocket("wss://localhost:8400");
