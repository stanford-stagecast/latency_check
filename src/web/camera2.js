...
function sourceOpenVideo(e) {
    ...
    document.getElementById('zooms').innerHTML = 'Camera control for: <b><span id="text:live"></span></b><br><button onclick="reset_controls();" type="button">Reset controls</button><br><span style="float: left; width: 200px;" id="text:zoom:x">x</span><input type="range" min="0" max="3840" step="1" id="zoom:x" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:zoom:y">y</span><input type="range" min="0" max="3840" step="1" id="zoom:y" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:zoom:zoom">zoom</span><input type="range" min="1" max="3" step="0.001" id="zoom:zoom" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:left">crop</span><input type="range" min="0" max="3840" step="1" id="crop:left" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:right">crop</span><input type="range" min="0" max="3840" step="1" style="transform: rotate(180deg); width: 1280px;" id="crop:right" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:top">crop</span><input type="range" min="0" max="2160" step="1" id="crop:top" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br><span style="float: left; width: 200px;" id="text:crop:bottom">crop</span><input type="range" min="0" max="2160" step="1" id="crop:bottom" style="width: 1280px;" onmousedown="this.ignoring = true;" onmouseup="this.ignoring = false;" oninput="send_control(this.id, value);"><br>';
